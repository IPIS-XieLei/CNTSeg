...
def train(weights_out_path,fold):
    ...
    op_lr = 0.002  #
    # 训练集选择
    # train_fileflod = 'CN_mydata/fold2'
    ...
    # 模型载入
    # model.load_state_dict(torch.load('/media/brainplan/XLdata/CNTSeg++/Weights/Single/outputs_CN_FA/CN_130_epoch_64_batch.pth', map_location='cuda'))
...
if __name__ == '__main__':
    ...
    for fold in folds:
        print('/media/brainplan/XLdata/CNTSeg++/Weights/Single/'+ fold + '/outputs_CN_Peaks')
        weights_out_path = '/media/brainplan/XLdata/CNTSeg++/Weights/Single/'+ fold + '/outputs_CN_Peaks'
