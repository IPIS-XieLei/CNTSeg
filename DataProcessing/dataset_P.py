...
def CN_make_dirset(train_x_1_dir, train_x_2_dir, train_x_3_dir, train_y_1_dir, train_y_2_dir, train_y_3_dir, train_y_4_dir):
    train_x_1_path=[]
    train_x_2_path = []
    train_x_3_path = []
    train_y_1_path=[]
    ...
    for i in range(n):
        ...
        img_x_3 = os.path.join(train_x_3_dir, 'x_peaks-data_%d.nii.gz' % i)
    ...
    return train_x_1_path, train_x_2_path, train_x_3_path, train_y_1_path,train_y_2_path,train_y_3_path,train_y_4_path


class CN_MyTrainDataset(Dataset):
    def __init__(self, train_x_1_dir, train_x_2_dir, train_x_3_dir, train_y_1_dir, train_y_2_dir, train_y_3_dir, train_y_4_dir, x_transform=None, y_transform=None):
        train_x_1_path, train_x_2_path, train_x_3_path, train_y_1_path, train_y_2_path, train_y_3_path, train_y_4_path = CN_make_dirset(train_x_1_dir, train_x_2_dir, train_x_3_dir, train_y_1_dir, train_y_2_dir, train_y_3_dir, train_y_4_dir)
    ...
    def __getitem__(self, index):
        ...
        return img_x_1_data, img_x_2_data, img_x_3_data, img_y_0, img_y_1_data, img_y_2_data, img_y_3_data, img_y_4_data
...
if __name__ == '__main__':
    ...
    ON_train_x_CN_t1_dir = 'CN_mydata/train_T1_FA/x_t1_data/'
    ON_train_x_CN_fa_dir = 'CN_mydata/train_T1_FA/x_fa_data/'
    ON_train_x_CN_peaks_dir = 'CN_mydata/train_T1_FA/x_peaks_data/'
    ON_train_y_on_dir    = 'CN_mydata/train_T1_FA/y_data_on/'
    ON_train_y_tgn_dir = 'CN_mydata/train_T1_FA/y_data_tgn/'
    ON_train_y_fvn_dir = 'CN_mydata/train_T1_FA/y_data_fvn/'
    ON_train_y_ocn_dir = 'CN_mydata/train_T1_FA/y_data_ocn/'

    x_transforms = transforms.ToTensor()

    y_transforms = transforms.ToTensor()
    train_dataset = CN_MyTrainDataset(ON_train_x_CN_t1_dir, ON_train_x_CN_fa_dir, ON_train_x_CN_peaks_dir,ON_train_y_on_dir,ON_train_y_tgn_dir,ON_train_y_fvn_dir,ON_train_y_ocn_dir, x_transform=x_transforms, y_transform=y_transforms)
    train_dataloader = DataLoader(train_dataset, batch_size=batch_size, shuffle=True, num_workers=0)

    for train_x_1, train_x_2, train_x_3, train_y_0,train_y_1, train_y_2, train_y_3, train_y_4 in train_dataloader:
        print('x_1_shape=', train_x_1.shape)
        print('x_2_shape=', train_x_2.shape)
        print('x_3_shape=', train_x_3.shape)
        print('label_shape=', train_y_0.shape)
        print('label_shape=', train_y_1.shape)
        print('label_shape=', train_y_2.shape)
        print('label_shape=', train_y_3.shape)
        print('label_shape=', train_y_4.shape)
        print("done")
    print("done")
