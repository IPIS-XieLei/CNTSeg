    ...
    for test_num in test_dir:
        ...
        with torch.no_grad():
            for x1, x2, x3, x4, x5, y0, y1, y2, y3, y4 in test_dataloader:
                ...
                outputs1 = model1(inputs1_t1,inputs4_dec)
...
if __name__ == '__main__':
    ...
    ##
    model1 = NSYnet(1, 3, 5).to(device)
    model1 = nn.DataParallel(model1).cuda()
    folds = ['fold1','fold2', 'fold3', 'fold4', 'fold5']
    for fold in folds:
        pre_file_t1_name = '/media/brainplan/XLdata/CNTSeg++/Predict/NSYnet/' + fold + '/test_val'
        ...
        weight_path = '/media/brainplan/XLdata/CNTSeg++/Weights/NSYnet/' + fold
