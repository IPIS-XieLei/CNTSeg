...
if __name__ == '__main__':
    ...
    for fold in folds:
        print('/media/brainplan/XLdata/CNTSeg++/Weights/CNTSegV2/CNTSegV2_no_dedicated_without_CDA/' + fold)
        weights_out_path = '/media/brainplan/XLdata/CNTSeg++/Weights/CNTSegV2/CNTSegV2_no_dedicated_without_CDA/' + fold
