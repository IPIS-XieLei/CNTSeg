    ...
    for test_num in test_dir:
        ...
        with torch.no_grad():
            for x1, x2, x3, x4, x5, y0, y1, y2, y3, y4, mask in test_dataloader:
                ...
                outputs1= model1(inputs1_t1,inputs2_t2,inputs3_fa,inputs4_dec,inputs5_peaks,mask)
...
if __name__ == '__main__':
    ...
    for fold in folds:
        pre_file_t1_name = '/media/brainplan/XLdata/CNTSeg++/Predict/CNTSegV2/CNTSegV2_no_dedicated_without_ALL/' + fold + '/test_val'
        ...
        weight_path = '/media/brainplan/XLdata/CNTSeg++/Weights/CNTSegV2/CNTSegV2_no_dedicated_without_ALL/' + fold
