...
#### start train
    ...
    for epoch in range(0, 200):
        ...
        for x1, x2, x3, x4, x5, y0, y1, y2, y3, y4, mask in train_dataloader:
            ...
            loss_t1fa=0.5*loss_dl + 0.5*losses_ce + 0.5*losses_dis   # _1:0.5,smL1
...
if __name__ == '__main__':
    ...
    for fold in folds:
        print('/media/brainplan/XLdata/CNTSeg++/Weights/CNTSegV2/CNTSegV2_no_dedicated_final_e180/' + fold)
        weights_out_path = '/media/brainplan/XLdata/CNTSeg++/Weights/CNTSegV2/CNTSegV2_no_dedicated_final_e180/' + fold
