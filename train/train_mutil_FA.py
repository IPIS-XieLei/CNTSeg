...
#### start train
    ...
    for epoch in range(0, 500):
        ...
        model_path = 'outputs_CN_FA/' + 'CN_%d_epoch_%d_batch.pth' % (epoch + 1, batch_size)
...
if __name__ == '__main__':
    ...
    # 模型保存
    if 'outputs_CN_FA' not in os.listdir(os.curdir):
        os.mkdir('outputs_CN_FA')
