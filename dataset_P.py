...
class CN_MyTrainDataset(Dataset):
    def __init__(self, train_x_1_dir, train_x_2_dir, train_x_3_dir,train_x_4_dir,train_x_5_dir,train_y_1_dir, train_y_2_dir, train_y_3_dir, train_y_4_dir, x_transform=None, y_transform=None):
    ...
    def __getitem__(self, index):
        ...
        return img_x_1_data, img_x_2_data, img_x_3_data,img_x_4_data, img_x_5_data, img_y_0, img_y_1_data, img_y_2_data, img_y_3_data, img_y_4_data
