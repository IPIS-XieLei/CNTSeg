...
def predict(img_dir, predict_t1, imgs_num):
    ...
    model_fusion.load_state_dict(torch.load('outputs_CN_T1_FA/CN_500_epoch_64_batch.pth', map_location='cuda'))
    ...
    with torch.no_grad():
        for x1, x2, x3, y0, y1, y2, y3, y4 in test_dataloader:
            ...
            # outputs_fa = torch.sigmoid(outputs_fa)
            outputs_fusion = model_fusion(outputs_t1, outputs_fa)  # FA
...
if __name__ == '__main__':
    ...
    # 预测结果保存
    pre_file_t1 = 'predict_T1_FA'  # model1
